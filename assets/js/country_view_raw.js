...
fetch('//tvpeer.github.io/assets/json/country_list/allcountry.json')
...
'<div class="filter_list column is-4-desktop is-3-widescreen is-half-tablet">'+
        '<div class="card">'+
          ...
          '<div class="card-content">'+
            '<figure class="image">'+
              '<a href="view/?id='+jsonData[i]['code']+'"><img class="lazyload" src="//tvpeer.github.io/assets/image/icon/loading.svg" data-src="//i0.wp.com/tvpeer.github.io/assets/image/flag/'+jsonData[i]['code'].toLowerCase()+'-flag.jpg?q=60&w=250&h=250" alt="'+jsonData[i]['name']+'"></a>'+
            '</figure>'+
          '</div>'+
