        ...
        const OfflinePlayback = "https://tvpeer.github.io/assets/offline_playback/playback.m3u8";
     
 function p2pmlConfig(url){
         if (p2pml.hlsjs.Engine.isSupported()) {
          const config = {
              loader: {
                  trackerAnnounce:["wss://tracker.openwebtorrent.com:443/announce","wss://tracker.openwebtorrent.com", "wss://tracker.files.fm:7073/announce", "wss://tracker.btorrent.xyz", "wss://spacetradersapi-chatbox.herokuapp.com:443/announce", "ws://tracker.files.fm:7072/announce"]
                  ,
                  rtcConfig: {
                      iceServers: [{
